...
for i, arg in enumerate(sys.argv):
    ...
    # Determine if argument is a number or a string
    try:
        # If argument can be converted to an int, assume it is a Pokedex number
        pokedex_number = int(arg)
    except ValueError:
        # Otherwise, assume it is a Pokemon name and look up the Pokedex number
